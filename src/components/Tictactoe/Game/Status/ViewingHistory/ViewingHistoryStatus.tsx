...
const ViewingHistoryStatus: FC<ViewingHistoryPropsI> = ({ statusComponent, tooltip }) => {
	const defaultTooltip: string =
		'In this mode, you cannot make moves, start or stop the game. You can only view past game states.';
	...
	return (
		<div className='t3-status t3-status--vh'>
			...
			<div className='t3-status-vh__inline'>{statusComponent}</div>
		</div>
	);
};
