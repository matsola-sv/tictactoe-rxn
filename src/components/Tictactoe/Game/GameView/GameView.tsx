...
const MobileGame = lazy(
	() => import('components/Tictactoe/Game/Templates/MobileGame/MobileGame'),
);
const DesktopGame = lazy(
	() => import('components/Tictactoe/Game/Templates/DesktopGame/DesktopGame'),
);
